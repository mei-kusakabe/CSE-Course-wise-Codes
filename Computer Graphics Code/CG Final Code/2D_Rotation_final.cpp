...
void before_rotation(int p1,int q1,int p2,int q2,int p3,int q3)
{
    setcolor(YELLOW);
    line(p1,q1,p2,q2);
    line(p2,q2,p3,q3);
...
void after_rotation(int p1,int q1,int p2,int q2,int p3,int q3)
{
    setcolor(CYAN);
    line(p1,q1,p2,q2);
    line(p2,q2,p3,q3);
...
int main()
{
    ...
    before_rotation(x1,y1,x2,y2,x3,y3);
    after_rotation(a1,b1,a2,b2,a3,b3);
    getch();
